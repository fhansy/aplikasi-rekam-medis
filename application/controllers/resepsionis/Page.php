...
class Page extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['poliUmum']=$this->M_Pendaftaran->getJmlAntrianPoli($this->session->userdata('tgl_sekarang'),'Poli Umum');
		$this->data['poliKIA']=$this->M_Pendaftaran->getJmlAntrianPoli($this->session->userdata('tgl_sekarang'),'Poli KIA');
